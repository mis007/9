...
type IconName = 'microphone' | 'camera' | 'bag' | 'arrow-left' | 'logout' | 'location' | 'play' | 'pause' | 'chat-bubble' | 'book-open' | 'price-tag' | 'user' | 'academic-cap' | 'document-chart-bar' | 'view-dashboard' | 'clock' | 'map' | 'navigation' | 'plus' | 'check-circle' | 'upload' | 'clipboard' | 'x' | 'sun' | 'moon' | 'calendar' | 'bell' | 'chevron-down' | 'home';

const strokedIcons: Record<string, React.ReactElement> = {
  ...
  'book-open': <path strokeLinecap="round" strokeLinejoin="round" d="M12 6.042A8.967 8.967 0 006 3.75c-1.052 0-2.062.18-3 .512v14.25A8.987 8.987 0 016 18c2.305 0 4.408.867 6 2.292m0-14.25a8.966 8.966 0 016-2.292c1.052 0 2.062.18 3 .512v14.25A8.987 8.987 0 0018 18a8.967 8.967 0 00-6-2.292m0 0v14.25" />,
  'price-tag': <path strokeLinecap="round" strokeLinejoin="round" d="M9.568 3H5.25A2.25 2.25 0 003 5.25v4.318c0 .597.237 1.17.659 1.591l9.581 9.581c.699.699 1.78.872 2.607.33a18.095 18.095 0 005.223-5.223c.542-.827.369-1.908-.33-2.607L11.16 3.66A2.25 2.25 0 009.568 3zM12 9a.75.75 0 100-1.5.75.75 0 000 1.5z" />,
  user: <path strokeLinecap="round" strokeLinejoin="round" d="M15.75 6a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0zM4.501 20.118a7.5 7.5 0 0114.998 0A17.933 17.933 0 0112 21.75c-2.676 0-5.216-.584-7.499-1.632z" />,
  'academic-cap': <path strokeLinecap="round" strokeLinejoin="round" d="M4.26 10.147a60.436 60.436 0 00-.491 6.347A48.627 48.627 0 0112 20.904a48.627 48.627 0 018.232-4.41 60.46 60.46 0 00-.491-6.347m-15.482 0a50.57 50.57 0 00-2.658-.813A59.905 59.905 0 0112 3.493a59.902 59.902 0 0110.399 5.84c-.896.248-1.783.52-2.658.814m-15.482 0l-2.098.563m2.098-.562l-2.098-.562m0 0l2.098.563m2.098-.562l2.098.562M3.75 12.14l-2.098.562 2.098.563m0 0l2.098-.562m-2.098.562l-2.098-.563m2.098.562l2.098.563m7.5-9.498l2.098.562-2.098.562m0 0l-2.098-.562m2.098.562l2.098.562m0 0l2.098.563m-2.098-.563l-2.098-.562m-2.098.562l-2.098.563" />,
  'document-chart-bar': <><path strokeLinecap="round" strokeLinejoin="round" d="M10.125 2.25h-4.5c-.621 0-1.125.504-1.125 1.125v17.25c0 .621.504 1.125 1.125 1.125h12.75c.621 0 1.125-.504 1.125-1.125v-9M10.125 2.25h.375a9 9 0 0 1 9 9v.375M10.125 2.25v3.375c0 .621.504 1.125 1.125 1.125h3.375" /><path strokeLinecap="round" strokeLinejoin="round" d="M16.5 17.25v-3.75m-3 3.75v-1.5m-3 1.5v-6" /></>,
  'view-dashboard': <path strokeLinecap="round" strokeLinejoin="round" d="M6 6h12v12H6V6zm0 0l6 6m-6 0l6-6m-6 6h12m-12 0v12m12 0H6" />,
  'clock': <path strokeLinecap="round" strokeLinejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />,
  'map': <path strokeLinecap="round" strokeLinejoin="round" d="M9 20.25l-4.5-2.25m4.5 2.25v-8.25m4.5 2.25l4.5-2.25m-4.5 2.25v-8.25m-4.5-2.25l4.5 2.25m0 0l4.5-2.25m-4.5 2.25v8.25m0 0l4.5 2.25m0-8.25l-4.5-2.25m-4.5 2.25l4.5-2.25" />,
  ...
  'clipboard': <path strokeLinecap="round" strokeLinejoin="round" d="M15.666 3.888A2.25 2.25 0 0013.5 2.25h-3c-1.03 0-1.9.693-2.166 1.638m7.332 0c.055.194.084.4.084.612v0a.75.75 0 01-.75.75H9a.75.75 0 01-.75-.75v0c0-.212.03-.418.084-.612m7.332 0c.646.049 1.288.11 1.927.184 1.1.128 1.907 1.077 1.907 2.185V19.5a2.25 2.25 0 01-2.25 2.25H6.75A2.25 2.25 0 014.5 19.5V6.257c0-1.108.806-2.057 1.907-2.185a48.208 48.208 0 011.927-.184" />,
...
const filledIcons: Record<string, React.ReactElement> = {
  navigation: <path d="M12 2L4.5 20.29l.71.71L12 18l6.79 3 .71-.71L12 2z" />,
};
